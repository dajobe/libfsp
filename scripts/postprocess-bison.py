#!/usr/bin/python3
"""
Post-process files generated by bison to eliminate warnings and improve compatibility.
...
* Addresses compiler warnings at high warning levels

Usage:
  bison -o parser.c parser.y
  python3 postprocess-bison.py parser.c

The script modifies the file in-place, creating a .bak backup.
